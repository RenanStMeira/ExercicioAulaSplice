//tipo de valor array (lista)

let nomeSobrenomeUltimoNome = ['Renan' , 'Santos', 'Meira' ]; //tipo array
//console.log(nomeSobrenomeUltimoNome[0])
...
adicionarNovaReceita(3, 'pizza de frango', 'medio', ['farinha', 'ovo', 'frango', 'fermento'], false)
